...
import PresenceBar from "../components/Basket/PresenceBar";
...
import BasketCollaborationProvider from "../state/providers/BasketCollaborationProvider";
      ...
      <BasketProvider>
        <div className="flex min-h-screen min-w-80 flex-col">
          ...
          <main className="flex flex-col px-3 py-5 lg:container lg:mx-auto lg:px-20 2xl:px-44 3xl:px-64">
            ...
            <BasketHeader />
            {/* Only rendered when this page was opened with a ?share= session link */}
            <PresenceBar />
