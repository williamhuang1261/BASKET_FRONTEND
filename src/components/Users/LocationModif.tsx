...
const LocationModif = () => {
  ...
  return (
    <>
      <h2 className="my-3 font-semibold">Location</h2>
      {active ? (
        <div className="relative flex w-full rounded outline-none md:w-8/12">
          <div className="h-full w-full">
            <LocationAutoComplete
              id="User_Settings"
              inputClassName="outline-none w-full h-12 px-2 border rounded-s"
              dropdownClassName="z-50 w-full rounded bg-white"
          ...
          <button className="h-12 rounded-e bg-green/75 px-3 transition-all duration-150 ease-in-out hover:bg-green">
            Apply
          </button>
        </div>
      ) : (
