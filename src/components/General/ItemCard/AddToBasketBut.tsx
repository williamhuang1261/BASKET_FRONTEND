...
const AddToBasketBut = ({ onClick }: Props) => {
  return (
    <button
      onClick={onClick}
      className="flex w-full items-center justify-between rounded border-2 border-green/50 px-2 py-1 transition-all duration-150 ease-in-out hover:border-green hover:bg-green hover:shadow-md"
    >
      <FaPlus size={20} />
