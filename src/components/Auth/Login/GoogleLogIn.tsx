...
const GoogleLogIn = () => {
  return (
    <button
      className="flex h-10 w-full items-center justify-center gap-3 rounded border border-[#FBBC04] p-2 font-medium  transition-all duration-150 ease-in-out hover:bg-[#FBBC04]/50"
