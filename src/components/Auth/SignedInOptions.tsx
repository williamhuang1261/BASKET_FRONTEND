...
const NotSignedInOptions = () => {
  return (
    <div className="absolute -left-14 z-10 grid w-28 grid-rows-2 rounded-sm border-[0.5px] border-dark_gray bg-white">
      <CustomDirectNav
        pathname={"/account"}
        aria-label="Go to Profile Page"
        className="flex cursor-pointer items-center justify-center border-b-[0.5px] p-1 border-gray-200 hover:bg-light_gray"
      >
        Settings
      </CustomDirectNav>
      <LogOut />
